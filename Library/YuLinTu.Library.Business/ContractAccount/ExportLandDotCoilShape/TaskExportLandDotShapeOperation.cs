...
{
   public class TaskExportLandDotShapeOperation: Task
    {
        #region Fields
       ...
       private string openFilePath;  //打开文件路径
        ...
        public TaskExportLandDotShapeOperation()
        {
        }
        ...
        protected override void OnGo()
        {
            ...
            var business = new ExportLandDotShapeBusiness();
            ...
            returnValue = business.ExportZoneShape(zone, openFilePath);
            if (returnValue)
            {
                CanOpenResult = true;
            }            
