...
namespace YuLinTu.Library.Basic
{
    public class ToolCoding
    {
        ...
        {
            string fullCode = YuLinTu.Library.Basic.ToolCoding.EncodeToMD5(tokenCode);
            fullCode += YuLinTu.Library.Basic.ToolCoding.EncodeToMD5("yulintu");
            fullCode += YuLinTu.Library.Basic.ToolCoding.EncodeToMD5("songsong");
        ...
        public static void InitalizeTokenFile(string fileName, string tokenCode)
        {
            ...
            string tokenstring = YuLinTu.Library.Basic.ToolString.SplitIn(tokenString, '-', 5).ToUpper();
