...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量颁证清册任务类
    /// </summary>
    public class TaskGroupExportAwareTableOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportAwareTableOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportAwareTableArgument groupArgument = Argument as TaskGroupExportAwareTableArgument;
