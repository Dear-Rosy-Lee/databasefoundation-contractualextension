...
{
    [View(typeof(BlankBackstageDialog))]
    public partial class BlankBackstageDialogViewModel : ViewModelObject,
        ...
        IMetroDialogLifetimeHandlerCancel
    {
        ...
        private string _Description = "BlankBackstageDialog Content";
        ...
        public BlankBackstageDialogViewModel(IDialogOwner owner)
        {
            DialogOwner = owner;
        }
