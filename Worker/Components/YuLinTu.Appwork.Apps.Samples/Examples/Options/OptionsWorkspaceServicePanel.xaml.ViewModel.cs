...
{
    [View(typeof(OptionsWorkspaceServicePanel))]
    public partial class OptionsWorkspaceServicePanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties
        ...
        private void OnOpenOptionsDialog(object args)
        {
            Workpage.Workspace.Message.Send(this, new MsgEventArgs<string>(
                EdCore.langShowOptionsDialog) { Parameter = LanguageAttribute.GetLanguage("lang1010016") });
        }
        ...
        public OptionsWorkspaceServicePanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
