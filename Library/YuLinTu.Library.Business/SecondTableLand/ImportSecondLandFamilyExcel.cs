...
namespace YuLinTu.Library.Business
{
    ...
    /// </summary>
    [Serializable]
    public class ImportSecondLandFamilyExcel : ExportExcelBase
    {
        #region Fields
        ...
        #region Ctor
        public ImportSecondLandFamilyExcel()
        {
        ...
        {
            SetRang("A" + index, "S" + index, 27.75, 18, true, DeclareTableName + "区、县（市）农村土地承包经营权摸底调查公示确认表");
            index++;
        ...
        {
            return string.Format("{0: yyyy 年 MM 月 dd 日}", DateTime.Now);
        }
        #endregion
