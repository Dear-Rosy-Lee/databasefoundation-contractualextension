...
namespace YuLinTu.Library.Business
{
    ...
    /// 导入界址点图斑数据操作任务类
    /// </summary>
    public class TaskImportDotOperation : Task
    {
        #region Ctor
        ...
        private ImportBoundaryAddressDotDefine importBoundaryDotDefine= ImportBoundaryAddressDotDefine.GetIntence();
        ...
        {
            TaskImportDotArgument metadata = Argument as TaskImportDotArgument;
            if (metadata == null)
            {
                return;
            }
