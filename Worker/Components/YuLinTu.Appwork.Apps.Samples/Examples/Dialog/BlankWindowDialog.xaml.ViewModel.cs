...
{
    [View(typeof(BlankWindowDialog))]
    public partial class BlankWindowDialogViewModel : ViewModelObject,
        ...
        IMetroDialogLifetimeHandlerCancel
    {
        ...
        private string _Description = "BlankWindowDialog Content";
        ...
        public BlankWindowDialogViewModel()
        {
        }
