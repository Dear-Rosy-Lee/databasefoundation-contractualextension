...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出测绘申请书任务类
    /// </summary>
    public class TaskGroupExportSurveyBookOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportSurveyBookOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportSurveyBookArgument groupArgument = Argument as TaskGroupExportSurveyBookArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportSurveyBookArgument argument = new TaskExportSurveyBookArgument();
                ...
                TaskExportSurveyBookOperation operation = new TaskExportSurveyBookOperation();
                operation.Argument = argument;
                operation.Name = "批量导出测绘申请书";
