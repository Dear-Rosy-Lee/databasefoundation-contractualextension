...
namespace YuLinTu.Appwork.Apps.Samples.Examples.Dialog
{
    ...
    public class PersonDetailsExtends : NotifyInfoCDObject
    {
        #region Properties
        ...
        [Windows.Wpf.Metro.Components.PropertyDescriptor(Catalog = "分组 1",
            Builder = typeof(PropertyDescriptorBuilderReadOnlyTextBox))]
        ...
        [Windows.Wpf.Metro.Components.PropertyDescriptor(Catalog = "分组 1", ColumnSpan = 2, Height = 100,
            Builder = typeof(PropertyDescriptorBuilderMultiLineReadOnlyTextBox))]
        ...
        [DisplayLanguage("参数 CComment")]
        [Windows.Wpf.Metro.Components.PropertyDescriptor(Class = "Class 2", Catalog = "分组 2", ColumnSpan = 2, Height = 100,
            Builder = typeof(PropertyDescriptorBuilderMultiLineReadOnlyTextBox))]
        public string CComment
        {
            get { return _CComment; }
            set { _CComment = value; NotifyPropertyChanged(() => CComment); }
        }
