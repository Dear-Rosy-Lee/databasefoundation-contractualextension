...
namespace YuLinTu.Library.Business
{
    ...
    /// 摸底核实表设置实体
    /// </summary>
    public class LandVerifyDefine : NotifyCDObject
    {
        #region Propertys
