...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量承包地块Word调查表任务类
    /// </summary>
    public class TaskGroupExportLandWordOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportLandWordOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportLandWordArgument groupArgument = Argument as TaskGroupExportLandWordArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                operation.Name = "批量导出承包地块Word调查表";
