...
{
    /// <summary>
    /// ImportDataCommon.xaml 的交互逻辑
    /// </summary>
    public partial class ImportDataCommon: InfoPageBase
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public ImportDataCommon(IWorkpage page, Zone currentZone, string desc = "",bool ZoneVisib=true)
        {
            InitializeComponent();
            DataContext = this;
            this.Workpage = page;
            ...
            ComBusinessDefine = CommonSelectZoneDefine.GetIntence();
            if(!ZoneVisib)
            {
            ...
            if (currentZone != null)
            {
                ComBusinessDefine.CurrentZoneFullName = currentZone.FullName;
                ComBusinessDefine.CurrentZoneFullCode = currentZone.FullCode;
            }
            if(SelectZone==null)
            {
                SelectZone = new Zone();
                SelectZone.FullCode = ComBusinessDefine.CurrentZoneFullCode;
                SelectZone.FullName = ComBusinessDefine.CurrentZoneFullName;
            }
        }
        ...
        private object importDataDefine;
        ...
        /// </summary>
        public CommonSelectZoneDefine ComBusinessDefine
        {
            get { return (CommonSelectZoneDefine)GetValue(ComBusinessDefineProperty); }
            set { SetValue(ComBusinessDefineProperty, value); }
        }

        public static readonly DependencyProperty ComBusinessDefineProperty =
            DependencyProperty.Register("ComBusinessDefine", typeof(CommonSelectZoneDefine), typeof(ImportDataCommon));
        ...
        /// 图斑实体配置
        /// </summary>
        public object ImportDataDefine
        {
            get { return importDataDefine; }
            set
            {
                importDataDefine = value;
                this.ProGrid.Object = ImportDataDefine;
            }
        }
        ...
        private void OnLoadConfig(List<string> dotColumnList)
        {
            ...
            //ProGrid.Properties[PropertiesName] = FileName;
            ...
            //config = (section.Settings as T);   //得到经反序列化后的对象
            ...
            ImportDataDefine = configCopy as object;
        }
        ...
        private void btnChangeCommon_Click(object sender, RoutedEventArgs e)
        {
            ...
            zoneSelectorPanel.SelectorZone = new ZoneDataItem() { FullCode = SelectZone != null ? SelectZone.FullCode : ComBusinessDefine.CurrentZoneFullCode };
            ...
            {
                this.ComBusinessDefine.CurrentZoneFullName = zoneSelectorPanel.RootZone.FullName;
                this.ComBusinessDefine.CurrentZoneFullCode = zoneSelectorPanel.RootZone.FullCode;
            };
        ...
        private void allCheck_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                if (!allCheck.IsChecked.Value)
                {
                    ...
                    info.SetValue(ImportDataDefine, "None", null);
                    continue;
                }
                if (display == null)
                    continue;
                ...
                if (fvalue)
                {
                    info.SetValue(ImportDataDefine, display.Name, null);
                }
            }
        }
