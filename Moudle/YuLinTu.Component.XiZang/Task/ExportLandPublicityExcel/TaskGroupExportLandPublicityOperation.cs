...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    /// 批量导出公示结果归户表类
    /// </summary>
    public class TaskGroupExportLandPublicityOperation : TaskGroup
   {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportLandPublicityOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportLandPublicityArgument groupArgument = Argument as TaskGroupExportLandPublicityArgument;
