...
namespace YuLinTu.Component.CoordinateTransformTask
{
    ...
    public abstract class ExcelBase : TemplateBase, IDisposable
    {
        ...
        public void SaveAs(string fileName)
        {
            ...
            fileName = InitalizeValideFileName(fileName);
            string extension = System.IO.Path.GetExtension(fileName);
            if (string.IsNullOrEmpty(extension))
            {
                fileName += ".xls";
        ...
        /// <summary>
        /// 初始化单元格的内容，要求单元格的行列索引一致
        /// </summary>
        /// <param name="start"></param>
        /// <param name="end"></param>
        /// <param name="value"></param>
        public void InitalizeCellValue(string cellTag, object value)
        {
            InitalizeRangeValue(cellTag, cellTag, value);
        }
