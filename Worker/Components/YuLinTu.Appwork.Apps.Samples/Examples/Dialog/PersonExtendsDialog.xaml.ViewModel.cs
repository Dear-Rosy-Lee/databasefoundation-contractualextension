...
{
    [View(typeof(PersonExtendsDialog))]
    public partial class PersonExtendsDialogViewModel : ViewModelObject,
        ...
        IMetroDialogLifetimeHandlerCancel
    {
        ...
        public PersonExtendsDialogViewModel(IDialogOwner owner)
        {
            DialogOwner = owner;
        }
