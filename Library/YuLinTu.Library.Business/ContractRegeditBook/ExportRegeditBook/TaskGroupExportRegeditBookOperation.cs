...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出登记薄任务类
    /// </summary>
    public class TaskGroupExportRegeditBookOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportRegeditBookOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportRegeditBookArgument groupArgument = Argument as TaskGroupExportRegeditBookArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportRegeditBookArgument argument = new TaskExportRegeditBookArgument();
                ...
                TaskExportRegeditBookOperation operation = new TaskExportRegeditBookOperation();
                operation.Argument = argument;
                operation.Name = "批量导出登记簿";
