...
namespace YuLinTu.Library.Business
{
    ...
    /// 数据汇总表
    /// </summary>
    public class TaskGroupConcordInformationTableOperation : TaskGroup
    {
        ...
        {
            Clear();
            TaskGroupConcordInformationTableArgument groupMeta = Argument as TaskGroupConcordInformationTableArgument;
            if (groupMeta == null)
            {
                return;
            }
