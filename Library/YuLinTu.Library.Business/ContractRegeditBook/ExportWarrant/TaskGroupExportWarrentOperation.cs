...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出证书任务类
    /// </summary>
    public class TaskGroupExportWarrentOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportWarrentOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportWarrentArgument groupArgument = Argument as TaskGroupExportWarrentArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportWarrentArgument argument = new TaskExportWarrentArgument();
                ...
                argument.ExtendUseExcelDefine = groupArgument.ExtendUseExcelDefine;
                argument.BookLandNum = groupArgument.BookLandNum;
                argument.BookPersonNum = groupArgument.BookPersonNum;
                argument.BookNumSetting = groupArgument.BookNumSetting;
                TaskExportWarrentOperation operation = new TaskExportWarrentOperation();
                operation.Argument = argument;
                operation.Name = "批量导出证书";
