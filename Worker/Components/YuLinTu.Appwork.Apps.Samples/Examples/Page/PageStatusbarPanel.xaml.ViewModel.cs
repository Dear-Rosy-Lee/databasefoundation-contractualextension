...
{
    [View(typeof(PageStatusbarPanel))]
    public partial class PageStatusbarPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "Statusbar Description";
        ...
        public PageStatusbarPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
