...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    public class ContractRegeditBookPrinterData
    {
        ...
        private YuLinTu.Library.Entity.ContractRegeditBook book;
        ...
        public string UseType
        {
            get
            {
                ...
                val = (string.IsNullOrEmpty(val) || Library.Business.ToolMath.MatchEntiretyNumber(val)) ? "种植业" : val;
                return val;
            }
        }
        ...
        /// 权证
        /// </summary>
        public YuLinTu.Library.Entity.ContractRegeditBook Book
        {
            get
            {
                return book;
        ...
        private void InitializeLands()
        {
            ...
            useActualArea = true;
            string value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("UseActualAreaForAwareArea", "true");
            Boolean.TryParse(value, out useActualArea);//使用实测面积作为颁证面积
            listLands = landStation.GetCollection(FamilyEntry.ID);
        ...
        private void InitializeSharePerson()
        {
            ...
            string value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("ExportSharePersonRelationInformation", "false");
            Boolean.TryParse(value, out showPersonRelation);
            ShowPersonRealation = showPersonRelation;
            bool showPersonBirthday = false;
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("ExportSharePersonBirthdayInformation", "false");
            Boolean.TryParse(value, out showPersonBirthday);
            ShowPersonBirthday = showPersonBirthday;
            bool exceptTabAreaColumn = false;
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("ExceptTableAreaColumnSetting", "false");
            ...
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("SetLandNeighborFourColumnInformation", "false");
            ...
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("TableAreaColumnReplaceAwareArea", "false");
            ...
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("ExceptIsFarmerLandColumnSetting", "false");
            ...
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("NoWriteLandTableAreaSetting", "false");
            ...
            value = Library.Business.ToolConfiguration.GetSpecialAppSettingValue("ExportLandTypeInformationSetting", "false");
        ...
        private string GetZoneNameWithoutCityName(string codeZone)
        {
            ...
            name = zone.FullName.Replace(cityZone.FullName, string.Empty);
