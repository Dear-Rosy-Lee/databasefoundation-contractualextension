...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导入界址线图斑数据操作任务类
    /// </summary>
    public class TaskGroupImportCoilOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupImportCoilOperation()
        {
        ...
        {
            Clear();
            TaskGroupImportCoilArgument groupMeta = Argument as TaskGroupImportCoilArgument;
            if (groupMeta == null)
            {
                return;
            }
            ...
            {
                var currentZoneDotList = dotStation.GetByZoneCode(zone.FullCode, eSearchOption.Precision, ((int)eLandPropertyRightType.AgricultureLand).ToString());
