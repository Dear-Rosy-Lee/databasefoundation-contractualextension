...
{
    [View(typeof(PersonExtendsBackstageDialog))]
    public partial class PersonExtendsBackstageDialogViewModel : ViewModelObject,
        ...
        IMetroDialogLifetimeHandlerCancel
    {
        ...
        public FormValidationPersonExtends Person
        {
            get { return _Person; }
            set { _Person = value; NotifyPropertyChanged(() => Person); }
        }
        private FormValidationPersonExtends _Person = new FormValidationPersonExtends();
        ...
        #region Commands - InitializeProperty

        public DelegateCommand CommandInitializeProperty { get { return _CommandInitializeProperty ?? (_CommandInitializeProperty = new DelegateCommand(args => OnInitializeProperty(args), args => OnCanInitializeProperty(args))); } }
        private DelegateCommand _CommandInitializeProperty;

        private bool OnCanInitializeProperty(object args)
        {
            return true;
        }

        private void OnInitializeProperty(object args)
        {
        }
        ...
        public PersonExtendsBackstageDialogViewModel(IDialogOwner owner)
        {
            DialogOwner = owner;
        }
