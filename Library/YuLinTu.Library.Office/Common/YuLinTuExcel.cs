...
namespace YuLinTu.Library.Office
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ExcelBase : TemplateBase, IDisposable
    {
        #region Fields

        private object missing = System.Reflection.Missing.Value;//类型OpenExcelFile
        public Workbook workbook;//工作薄
        public Worksheet workSheet = null;//工作表
        ...
        public ExcelBase()
        {
            ...
            base.TemplateType = TemplateType.Excel;
        }
        ...
        public void PrintView()
        {
            ...
            filePath += System.IO.Path.GetFileName(fileName) + ".xls";
        ...
        public void PrintView(string path)
        {
            if (!File.Exists(path))
            {
                return;
        ...
        public void Print()
        {
            ...
            List<string> printers = YuLinTuPrinter.GetLocalPrinters();
        ...
        public bool Open(string fileName)
        {
            ...
            try
            {
                ...
                if (workbook != null)
                {
                    ...
                    {
                        Worksheets.Add(workbook.Worksheets[i]);
                    }
        ...
        public void Show()
        {
            ...
            fileName = WordOperator.InitalizeValideFileName(fileName);
            string filePath = WordOperator.InitalzieDefatultDirectory();
            filePath += System.IO.Path.GetFileNameWithoutExtension(fileName) + ".xls";
            int i = 1;
            bool newfile = false;
            ...
            if (newfile)
            {
                ...
                {
                    filePath = System.IO.Path.GetFileNameWithoutExtension(fileName) + "(" + i + ").xls";
                    i++;
                }
            }
            WordOperator.InitalzieDirectory(filePath);
        ...
        /// </summary>
        /// <returns></returns>
        public object[,] GetAllRangeValue(int maxCoulum = 0)
        {
            if (workSheet == null)
            {
                return null;
            ...
            if (maxCoulum != 0 && clumnCount < maxCoulum)
                clumnCount = maxCoulum;
        ...
        /// <param name="end"></param>
        /// <param name="value"></param>
        public void InitalizeCellValuePublishExcelUse(int start, int end, object value, int setUnderLineStartIndex1, int setUnderLineLenth1, int setUnderLineStartIndex2, int setUnderLineLenth2)
        {
            if (workbook == null || workSheet == null)
            {
                return;
        ...
        /// 给合并excel项加下划线
        /// </summary>
        /// <param name="rangeIndex">合并单元格在合并单元格集合中水平的序号</param>
        /// <param name="setUnderLineStartIndex">下划线开始位置</param>
        /// <param name="setUnderLineLenth">下划线长度</param>
        public void SetCellValueUnderline(int rangeIndex, int setUnderLineStartIndex, int setUnderLineLenth)
        {
            Cell cell = workSheet.Cells.Ranges[rangeIndex][0, 0];
            if (cell == null)
            {
                return;
            }
            cell.Characters(setUnderLineStartIndex, setUnderLineLenth).Font.Underline = FontUnderlineType.Single;
        }
