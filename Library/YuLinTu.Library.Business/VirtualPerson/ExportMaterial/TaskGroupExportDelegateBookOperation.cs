...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出委托声明书任务类
    /// </summary>
    public class TaskGroupExportDelegateBookOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportDelegateBookOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportDelegateBookArgument groupArgument = Argument as TaskGroupExportDelegateBookArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportDelegateBookArgument argument = new TaskExportDelegateBookArgument();
                ...
                TaskExportDelegateBookOperation operation = new TaskExportDelegateBookOperation();
                operation.Argument = argument;
                operation.Name = "批量导出委托声明书";
