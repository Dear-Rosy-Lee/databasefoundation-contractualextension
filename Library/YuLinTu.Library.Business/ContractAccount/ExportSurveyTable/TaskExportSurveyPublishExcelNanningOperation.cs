...
namespace YuLinTu.Library.Business
{
    ...
    /// 
    /// </summary>
    public class TaskExportSurveyPublishExcelNanningOperation : Task
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskExportSurveyPublishExcelNanningOperation()
        { }
        ...
        {
            TaskExportSurveyPublishExcelNanningArgument argument = Argument as TaskExportSurveyPublishExcelNanningArgument;
            if (argument == null)
            {
                return;
            }
            ...
            try
            {
                ...
                bool canOpen = ExportSurveyPublishNanningExcel(argument, listPerson, listLand);
                if (canOpen)
                    CanOpenResult = true;
            }
            catch (Exception ex)
        ...
        /// 导出调查信息公示表
        /// </summary>
        public bool ExportSurveyPublishNanningExcel(TaskExportSurveyPublishExcelNanningArgument argument, List<VirtualPerson> vps, List<ContractLand> lands)
        {
            bool result = false;
            try
            {
                ...
                string tempPath = TemplateHelper.ExcelTemplate(TemplateFile.LandInfomationExcelNanning);
                ...
                string savePath = openFilePath + @"\" + excelName + TemplateFile.LandInfomationExcelNanning + ".xls";
            ...
            {
                result = false;
                this.ReportError("导出调查信息公示表（南宁）失败");
