...
{
    [View(typeof(PageSidebarClassicPanel))]
    public partial class PageSidebarClassicPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "PageSidebarClassicPanel Content";
        ...
        public PageSidebarClassicPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
