...
{
    [View(typeof(DataViewFixedColumnPagingDataGridPage))]
    public partial class DataViewFixedColumnPagingDataGridPageViewModel : ViewModelObject, IDisposable
    {
        #region Properties
        ...
        public DataViewFixedColumnPagingDataGridPageViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
