...
{
    public class ImportLandTiesTableLZ : Task
    {
        #region Fields
        ...
        private InitalizeLandTiesTableLZ landInfo;//初始化承包台账调查表信息
        ...
        /// 读取户籍信息
        /// </summary>
        public bool ReadLandTableInformation(List<string> fileName)
        {
            if (fileName == null)
            {
                return false;
            ...
            landInfo = new InitalizeLandTiesTableLZ();
            landInfo.CurrentZone = CurrentZone;
            landInfo.DbContext = DbContext;
            landInfo.Files = fileName;
        ...
        private void ImportLandFamily(LandFamily landFamily, int familyIndex)
        {
            ...
            List<ContractLand> temp = landFamily.LandCollection.Clone();
