...
namespace YuLinTu.Library.Business
{
    ...
    /// </summary>
    public class TaskAccountFiveTableOperation : Task
    {
        #region Fields
        ...
        /// 构造函数
        /// </summary>
        public TaskAccountFiveTableOperation()
        {
        }
            ...
            try
            {
                ...
                foreach (var item in selectVirtualPerson)
                {
                    ...
                    using (ExportContractorSurveyExcel export = new ExportContractorSurveyExcel())
                    {
                        ...
                        export.PostErrorInfoEvent += export_PostErrorInfoEvent;
                        returnValue = export.BeginExcel(null, null, zone.FullCode.ToString(), tempPath);
                    }
                }
                this.ReportProgress(100, "完成");
