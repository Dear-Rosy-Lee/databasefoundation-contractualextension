...
namespace YuLinTu.Library.Controls
{
    ...
    /// 导出数据选择界面
    /// </summary>
    public partial class ExportDataTypePage : InfoPageBase
    {
        #region Filds
        ...
        /// 构造方法
        /// </summary>
        public ExportDataTypePage(string Name, IWorkpage page, string header, string desc = "", string btnName = "",
            string lbPathName = "")
        {
            InitializeComponent();
            DataContext = this;
        ...
        private void tbpath_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            EportType = tbpath.SelectedIndex;
        }
    }
}
