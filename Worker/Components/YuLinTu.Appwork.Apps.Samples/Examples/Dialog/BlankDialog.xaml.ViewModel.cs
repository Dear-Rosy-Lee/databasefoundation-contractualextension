...
{
    [View(typeof(BlankDialog))]
    public partial class BlankDialogViewModel : ViewModelObject,
        ...
        IMetroDialogLifetimeHandlerCancel
    {
        ...
        private string _Description = "拖动标题栏可以移动对话框\r\n若当前为模态对话框，点击半透明黑色空白处\r\n会有出现一些对话框控制菜单\r\n使用键盘上的 ESC 按键，也可以关闭对话框";
        ...
        public BlankDialogViewModel(IDialogOwner owner)
        {
            DialogOwner = owner;
        }
