...
{
    [View(typeof(PageCustomSidebarPanel))]
    public partial class PageCustomSidebarPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "PageCustomSidebarPanel Content";
        ...
        public PageCustomSidebarPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
