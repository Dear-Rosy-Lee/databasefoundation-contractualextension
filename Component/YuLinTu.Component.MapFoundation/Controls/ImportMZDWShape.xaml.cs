...
{
    /// <summary>
    /// ImportMZDWShape.xaml 的交互逻辑
    /// </summary>
    public partial class ImportMZDWShape : InfoPageBase
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public ImportMZDWShape(IWorkpage page, Zone currentZone, string desc = "")
        {
            InitializeComponent();
            DataContext = this;
            this.Workpage = page;
            ...
            CommonBusinessSettingMZDWDefine = CommonBusinessDefine.GetIntence();
            if (currentZone != null)
            {
                CommonBusinessSettingMZDWDefine.CurrentZoneFullName = currentZone.FullName;
                CommonBusinessSettingMZDWDefine.CurrentZoneFullCode = currentZone.FullCode;
            }
        }
        ...
        private ImportMZDWDefine config;
        private ImportMZDWDefine importMZDWDefine;
        ...
        /// </summary>
        public CommonBusinessDefine CommonBusinessSettingMZDWDefine
        {
            get { return (CommonBusinessDefine)GetValue(CommonBusinessDefineMZDWProperty); }
            set { SetValue(CommonBusinessDefineMZDWProperty, value); }
        }

        public static readonly DependencyProperty CommonBusinessDefineMZDWProperty =
            DependencyProperty.Register("CommonBusinessSettingMZDWDefine", typeof(CommonBusinessDefine), typeof(ImportCBDShapeByRightMenu));
        ...
        /// 界址点图斑实体配置
        /// </summary>
        public ImportMZDWDefine ImportMZDWDefine
        {
            get { return importMZDWDefine; }
            set
            {
                importMZDWDefine = value;
                this.ProGrid.Object = ImportMZDWDefine;
            }
        }
        ...
        private void OnLoadConfig(List<string> dotColumnList)
        {
            ...
            var profile = systemCenter.GetProfile<ImportMZDWDefine>();  //得到section部分 此方法已经判断了section为空的情况，为空就用默认构造
            var section = profile.GetSection<ImportMZDWDefine>();
            config = (section.Settings as ImportMZDWDefine);   //得到经反序列化后的对象
            ...
            ImportMZDWDefine = configCopy as ImportMZDWDefine;
        }
        ...
        private void btnExcuteImport_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                config.CopyPropertiesFrom(ImportMZDWDefine);
                systemCenter.Save<ImportMZDWDefine>();
            }));
        ...
        private void btnChangeCommon_Click(object sender, RoutedEventArgs e)
        {
            ...
            zoneSelectorPanel.SelectorZone = new ZoneDataItem() { FullCode = SelectZone != null ? SelectZone.FullCode : CommonBusinessSettingMZDWDefine.CurrentZoneFullCode };
            ...
            {
                this.CommonBusinessSettingMZDWDefine.CurrentZoneFullName = zoneSelectorPanel.RootZone.FullName;
                this.CommonBusinessSettingMZDWDefine.CurrentZoneFullCode = zoneSelectorPanel.RootZone.FullCode;
            };
        ...
        {
            PropertyInfo[] infos = typeof(ImportMZDWDefine).GetProperties();
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                {
                    info.SetValue(ImportMZDWDefine, "None", null);
                    continue;
                }
                if (display == null)
                    continue;
                ...
                if (fvalue)
                {
                    info.SetValue(ImportMZDWDefine, display.Name, null);
                }
            }
        }
