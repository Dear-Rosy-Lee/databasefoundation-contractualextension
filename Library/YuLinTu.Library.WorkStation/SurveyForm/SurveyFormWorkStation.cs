...
{
    public sealed class SurveyFormWorkStation : Workstation<SurveyForm>, ISurveyFormWorkStation
    {
        #region Properties

        public new ISurveyFormRepository DefaultRepository
        {
            get { return base.DefaultRepository as ISurveyFormRepository; }
        ...
        public SurveyFormWorkStation(ISurveyFormRepository rep)
        {
        ...
        public List<SurveyForm> GetByZoneCode(string zoneCode, eSearchOption searchOption)
        {
