...
{
    /// <summary>
    /// ImportXZDWShape.xaml 的交互逻辑
    /// </summary>
    public partial class ImportXZDWShape : InfoPageBase
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public ImportXZDWShape(IWorkpage page, Zone currentZone, string desc = "")
        {
            InitializeComponent();
            DataContext = this;
            this.Workpage = page;
            ...
            CommonBusinessSettingXZDWDefine = CommonBusinessDefine.GetIntence();
            if (currentZone != null)
            {
                CommonBusinessSettingXZDWDefine.CurrentZoneFullName = currentZone.FullName;
                CommonBusinessSettingXZDWDefine.CurrentZoneFullCode = currentZone.FullCode;
            }
        }
        ...
        private ImportXZDWDefine config;
        private ImportXZDWDefine importXZDWDefine;
        ...
        /// </summary>
        public CommonBusinessDefine CommonBusinessSettingXZDWDefine
        {
            get { return (CommonBusinessDefine)GetValue(CommonBusinessDefineXZDWProperty); }
            set { SetValue(CommonBusinessDefineXZDWProperty, value); }
        }

        public static readonly DependencyProperty CommonBusinessDefineXZDWProperty =
            DependencyProperty.Register("CommonBusinessSettingXZDWDefine", typeof(CommonBusinessDefine), typeof(ImportCBDShapeByRightMenu));
        ...
        /// 界址点图斑实体配置
        /// </summary>
        public ImportXZDWDefine ImportXZDWDefine
        {
            get { return importXZDWDefine; }
            set
            {
                importXZDWDefine = value;
                this.ProGrid.Object = ImportXZDWDefine;
            }
        }
        ...
        private void OnLoadConfig(List<string> dotColumnList)
        {
            ...
            var profile = systemCenter.GetProfile<ImportXZDWDefine>();  //得到section部分 此方法已经判断了section为空的情况，为空就用默认构造
            var section = profile.GetSection<ImportXZDWDefine>();
            config = (section.Settings as ImportXZDWDefine);   //得到经反序列化后的对象
            ...
            ImportXZDWDefine = configCopy as ImportXZDWDefine;
        }
        ...
        private void btnExcuteImport_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                config.CopyPropertiesFrom(ImportXZDWDefine);
                systemCenter.Save<ImportXZDWDefine>();
            }));
        ...
        private void btnChangeCommon_Click(object sender, RoutedEventArgs e)
        {
            ...
            zoneSelectorPanel.SelectorZone = new ZoneDataItem() { FullCode = SelectZone != null ? SelectZone.FullCode : CommonBusinessSettingXZDWDefine.CurrentZoneFullCode };
            ...
            {
                this.CommonBusinessSettingXZDWDefine.CurrentZoneFullName = zoneSelectorPanel.RootZone.FullName;
                this.CommonBusinessSettingXZDWDefine.CurrentZoneFullCode = zoneSelectorPanel.RootZone.FullCode;
            };
        ...
        {
            PropertyInfo[] infos = typeof(ImportXZDWDefine).GetProperties();
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                {
                    info.SetValue(ImportXZDWDefine, "None", null);
                    continue;
                }
                if (display == null)
                    continue;
                ...
                if (fvalue)
                {
                    info.SetValue(ImportXZDWDefine, display.Name, null);
                }
            }
        }
