...
namespace YuLinTu.Library.Business
{
    ...
    /// 公示确认表设置实体
    /// </summary>
    public class PublicityConfirmDelayDefine : NotifyCDObject
    {
        #region Propertys
        ...
        public PublicityConfirmDelayDefine()
        {
            nameValue = true;
        ...
        /// </summary>
        /// <returns></returns>
        public static PublicityConfirmDelayDefine GetIntence()
        {
            var systemCenter = TheApp.Current.GetSystemSettingsProfileCenter();  //系统配置
            var profile = systemCenter.GetProfile<PublicityConfirmDelayDefine>();
            var section = profile.GetSection<PublicityConfirmDelayDefine>();
