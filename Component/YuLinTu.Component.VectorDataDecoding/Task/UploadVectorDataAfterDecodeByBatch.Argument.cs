...
{
    public class UploadVectorDataAfterDecodeByBatchArgument : TaskArgument
    {
        #region Properties
      ...
      UriImage16 = "pack://application:,,,/YuLinTu.Resources;component/Images/16/folder-horizontal-open.png")]
        ...
        public UploadVectorDataAfterDecodeByBatchArgument()
        {
        }
        private async System.Threading.Tasks.Task CheckShpFile(string resultFilePathP)
        {
            await System.Threading.Tasks.Task.Run(() =>
            {
                ...
                if(ShpFilesInfo.Count > 0&&dataCount>0) { ConfirmEnabled=true; }
            });
