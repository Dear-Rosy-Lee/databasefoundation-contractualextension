...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出承包方excel调查表任务类
    /// </summary>
    public class TaskGroupExportVPExcelOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportVPExcelOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportVPExcelArgument groupArgument = Argument as TaskGroupExportVPExcelArgument;
