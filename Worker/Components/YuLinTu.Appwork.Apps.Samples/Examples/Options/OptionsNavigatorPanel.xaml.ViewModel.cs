...
{
    [View(typeof(OptionsNavigatorPanel))]
    public partial class OptionsNavigatorPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties
        ...
        public OptionsNavigatorPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
