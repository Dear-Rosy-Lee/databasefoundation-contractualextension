...
{
    [View(typeof(PageSideToolbarPanel))]
    public partial class PageSideToolbarPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "PageSideToolbarPanel Content";
        ...
        public PageSideToolbarPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
