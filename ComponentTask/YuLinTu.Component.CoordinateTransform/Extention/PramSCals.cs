...
namespace YuLinTu.Component.CoordinateTransformTask
{
    ...
    public class PramSCals
    {
        ...
        public static void Canshu4(Point2d[] p1, Point2d[] p2, ref double rota, ref double scale, ref double dx,
            ref double dy)
        {
        ...
        /// <param name="dx x的平移"></param>
        /// <param name="dy y的平移"></param>
        public static void Canshu4(Point2d[] p1, Point2d[] p2, int PointCount, ref double rota, ref double scale,
        ...
        public static void Canshu7(Point3d[] p1, Point3d[] p2, int PointCount, ref double rotax, ref double rotay,
            ref double rotaz, ref double scale, ref double dx, ref double dy, ref double dz)
        {
