...
namespace YuLinTu.Library.Business
{
    ...
    /// 导入地块图斑设置实体
    /// </summary>
    public class ImportAccountLandShapeSettingDefine : NotifyCDObject
    {
        /// <summary>
        ///承包方名称
        /// </summary>
        ...
        {
            get { return vpFamilyNumberIndex; }
            set { vpFamilyNumberIndex = value; NotifyPropertyChanged("VpFamilyNumberIndex"); }
        }
        private string vpFamilyNumberIndex;
        ...
        private string surveyNumberIndex;
        ...
        ///备注
        /// </summary>
        [DisplayLanguage("是否登记", IsLanguageName = false)]
        [DescriptionLanguage("是否登记", IsLanguageName = false)]
        [PropertyDescriptor(Catalog = "地块信息", Gallery = "",
           Builder = typeof(PropertyDescriptorBuilderString), Trigger = typeof(PropertyTriggerFamilyImportConfigState))]
        public string IsRegisterIndex
        {
            get { return isRegisterIndex; }
            set { isRegisterIndex = value; NotifyPropertyChanged("IsRegisterIndex"); }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static ImportAccountLandShapeSettingDefine GetIntence()
        {
            var systemCenter = TheApp.Current.GetSystemSettingsProfileCenter();  //系统配置
            var profile = systemCenter.GetProfile<ImportAccountLandShapeSettingDefine>();
