...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    /// 导出农户基本信息公示表
    /// </summary>
    public class TaskExportFamilyGSBtOperation : Task
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskExportFamilyGSBtOperation()
        { }
        ...
        {
            TaskExportFamilyGSBArgument argument = Argument as TaskExportFamilyGSBArgument;
            if (argument == null)
            {
                return;
            }
            ...
            {
                YuLinTu.Library.Log.Log.WriteException(this, "TaskExportPublishWordOperation(导出农户基本信息公示表任务)", ex.Message + ex.StackTrace);
                this.ReportException(ex, "导出农户基本信息公示表出现异常!");
            }
        }
        ...
        /// 导出农户基本信息公示表
        /// </summary>
        public bool ExportFamilyGSBExcel(TaskExportFamilyGSBArgument argument, List<VirtualPerson> listPerson, List<ContractLand> listLand,
            List<Dictionary> listDict, CollectivityTissue tissue, List<ContractConcord> concords)
        {
            ...
            try
            {
                ...
                foreach (VirtualPerson vp in listPerson)
                {
                    ...
                    string tempPath = TemplateHelper.ExcelTemplate("西藏农村土地承包经营权农户基本信息公示表");
                    var export = new ExportFamilyGSB(tempPath,dictoryName);
                    ...
                    string fileName = openFilePath + @"\" + vp.Name + "-" + "西藏农村土地承包经营权农户基本信息公示表";
                    export.Write();
                ...
                result = true;
                string info = string.Format("{0}导出{1}户承包方,共{2}个农户基本信息公示表", markDesc, listPerson.Count, indexOfVp - 1);
            ...
            {
                result = false;
                this.ReportError("导出农户基本信息公示表失败");
                YuLinTu.Library.Log.Log.WriteException(this, "ExportLandWord(导出农户基本信息公示表)", ex.Message + ex.StackTrace);
            }
            return result;
        }
