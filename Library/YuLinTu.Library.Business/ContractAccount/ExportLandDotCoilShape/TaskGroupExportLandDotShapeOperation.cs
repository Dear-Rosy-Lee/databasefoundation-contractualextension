...
{
    public class TaskGroupExportLandDotShapeOperation : TaskGroup
    {
        ...
        {
            Clear();
            TaskGroupExportLandDotShapeArgument groupMeta = Argument as TaskGroupExportLandDotShapeArgument;
            if (groupMeta == null)
            {
                return;
            }
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportLandDotShapeArgument meta = new TaskExportLandDotShapeArgument();
                meta.CurrentZone = zone;
                meta.FileName = openFilePath;
                meta.Database = dbContext;
                meta.DictList = groupMeta.DictList;
                TaskExportLandDotShapeOperation import = new TaskExportLandDotShapeOperation();
                import.Argument = meta;
                import.Description = zone.FullName;
                import.Name = "导出界址点Shape图斑";
