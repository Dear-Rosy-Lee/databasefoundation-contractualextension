...
namespace YuLinTu.Library.Controls
{
    ...
    /// 导入界址点图斑界面
    /// </summary>
    public partial class ImportBoundaryAddressDotPage : InfoPageBase
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public ImportBoundaryAddressDotPage(IWorkpage page, string header = "", string desc = "")
        {
            InitializeComponent();
            DataContext = this;
            this.Header = header;
            ...
            importDotByType.UseLandCodeBindImport = true;
        ...
        private ImportBoundaryAddressDotDefine config;
        private ImportBoundaryAddressDotDefine importDotDefine;
        private SettingsProfileCenter systemCenter;
        //当前选择导入的类型
        public ImportDotByType importDotByType = new ImportDotByType();
        ...
        /// 界址点图斑实体配置
        /// </summary>
        public ImportBoundaryAddressDotDefine ImportDotDefine
        {
        ...
        private void OnLoadConfig(List<string> dotColumnList)
        {
            ...
            ProGrid.Properties["importDotByType"] = importDotByType;
            systemCenter = TheApp.Current.GetSystemSettingsProfileCenter();  //系统配置
            var profile = systemCenter.GetProfile<ImportBoundaryAddressDotDefine>();  //得到section部分 此方法已经判断了section为空的情况，为空就用默认构造
            var section = profile.GetSection<ImportBoundaryAddressDotDefine>();
            config = (section.Settings as ImportBoundaryAddressDotDefine);   //得到经反序列化后的对象
            ...
            ImportDotDefine = configCopy as ImportBoundaryAddressDotDefine;
        }
        ...
        private void btnExcuteImport_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dispatcher.Invoke(new Action(() =>
            {
                ...
                systemCenter.Save<ImportBoundaryAddressDotDefine>();
            }));
        ...
        private void chkUseLandCodeBindImport_Click(object sender, RoutedEventArgs e)
        {
            if (chkUseLandCodeBindImport.IsChecked.Value)
            {
                ...
                {
                    ImportDotDefine.LandNumberIndex = ImportDotDefine.LandNumberIndex;
                }
            }
        }
        ...
        {
            PropertyInfo[] infos = typeof(ImportBoundaryAddressDotDefine).GetProperties();
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                {
                    info.SetValue(ImportDotDefine, "None", null);
                    continue;
                }
                if (display == null)
                    continue;
                ...
                if (fvalue)
                {
                    info.SetValue(ImportDotDefine, display.Name, null);
                }
            }
        }
