...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    /// 批量导出地块调查表类
    /// </summary>
    public class TaskGroupExportFamilyGSBOperation : TaskGroup
   {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportFamilyGSBOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportFamilyGSBArgument groupArgument = Argument as TaskGroupExportFamilyGSBArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                var argument = new TaskExportFamilyGSBArgument();
                ...
                var operation = new TaskExportFamilyGSBtOperation();
