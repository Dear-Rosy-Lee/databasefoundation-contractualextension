...
namespace YuLinTu.Library.Business
{
    ...
    public class MandatoryField : INotifyPropertyChanged
    {
        ...
        [CheckItem("发包方", "发包方名称、发包方编码、发包方负责人、证件类型、证件号、发包方地址、调查员、调查日期等不能为空")]
        ...
        [CheckItem("承包方", "承包方户编号、承包方名称、承包方类型、承包方地址等不能为空")]
        ...
        [CheckItem("家庭成员", "成员姓名、成员性别、成员证件类型、证件号码、家庭关系等不能为空")]
        ...
        [CheckItem("地块信息", "地块名称、地块类别、土地利用类型、土地用途、实测面积等不能为空")]
        ...
        [CheckItem("合同信息", "合同编码、签订日期、承包期限起、承包期限止、承包方式，合同面积亩等不能为空")]
    ...
    public class DataCorrectness : INotifyPropertyChanged
    {
        ...
        [CheckItem("字段填写", "承包方类型、证件类型、性别、家庭关系、地块类别、土地用途、变化情况等字段填写满足值域检查要求")]
        ...
        [CheckItem("承包方姓名、成员姓名", "承包方姓名、成员姓名不能包含数字、空格，除了 · 以外的的特殊字符")]
        ...
        [CheckItem("调查人员、审核人员姓名", "调查人员、审核人员姓名不能包含数字、空格，除了 · 以外的的特殊字符；如果是多个人名，使用 、，；, ; 的分拆字符串后的名字符合名字的校验规则")]
        ...
        [CheckItem("调查记事、审核记事", "调查记事、审核记事等内容的长度不超过500个字符")]
    ...
    public class RuleOfIDCheck : INotifyPropertyChanged
    {
        ...
        [CheckItem("证件号码", "发包方、承包方、家庭成员等证件号码符合身份证的规则")]
    ...
    public class DataLogic: INotifyPropertyChanged
    {
        ...
        [CheckItem("地块类型", "地块类型为“承包地块”时，确权面积必须大于0；地块的承包方式必须为家庭承包方式")]
        ...
        [CheckItem("地块四至", "地块四至的东、南、西、北至，至少有3个方向不能为空")]
    ...
    public class DataRepeataBility : INotifyPropertyChanged
    {
        ...
        [CheckItem("集体唯一性", "单个发包方下不能有多个集体 (集体名称为：村集体、社集体、集体、集体地、组集体")]
        ...
        [CheckItem("编码唯一性", "单个发包方内承包方编码、承包方证件号码、成员身份证号码、地块编码等必须唯一")]
    ...
    public class Uniqueness : INotifyPropertyChanged
    {
        ...
        [CheckItem("整库编码唯一性", "承包方编码、承包方证件号码、成员身份证号码、地块编码等整库必须唯一")]
