...
{
    [View(typeof(PageComplexSidebarPanel))]
    public partial class PageComplexSidebarPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties
        ...
        public PageComplexSidebarPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
