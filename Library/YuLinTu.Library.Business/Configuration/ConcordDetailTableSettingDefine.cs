...
namespace YuLinTu.Library.Business
{
    ...
    /// 承包合同明细表设置
    /// </summary>
    public class ConcordDetailTableSettingDefine : NotifyCDObject
    {
        #region Propertys
        /// <summary>
        ///承包方名称
        ...
        #region Ctor
        public ConcordDetailTableSettingDefine()
        {
            nameValue = true;
            numberValue = true;
        ...
        /// </summary>
        /// <returns></returns>
        public static ConcordDetailTableSettingDefine GetIntence()
        {
            var systemCenter = TheApp.Current.GetSystemSettingsProfileCenter();  //系统配置
            var profile = systemCenter.GetProfile<ConcordDetailTableSettingDefine>();
            var section = profile.GetSection<ConcordDetailTableSettingDefine>();
