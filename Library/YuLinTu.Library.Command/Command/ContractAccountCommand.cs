...
namespace YuLinTu.Library.Command
{
    ...
    public class ContractAccountCommand
    {
        ...
        /// 导出(批量)调查信息公示表命令名称
        /// </summary>
        public const string ExportPublishExcelNanningName = "exportPublishNanningExcel";
        ...
        /// 导出(批量)调查信息公示表命令(南宁)
        /// </summary>
        public RoutedCommand ExportPublishNanningExcel = new RoutedCommand(ExportPublishExcelNanningName, typeof(Button));
        ...
        /// 导出(批量)调查信息公示表绑定（南宁）
        /// </summary>
        public CommandBinding ExportPublishNanningExcelBind = new CommandBinding();
        ...
        public void InstallCommand()
        {
            ...
            ExportPublishNanningExcelBind.Command = ExportPublishNanningExcel;
