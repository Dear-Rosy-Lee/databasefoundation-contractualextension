...
namespace YuLinTu.Product.YuLinTuTool
{
    ...
    public class UpdateProgram
    {
        ...
        private static void AutoUpdaterOnCheckForUpdateEvent(UpdateInfoEventArgs args)
        {
            ...
            {
                dialogResult = System.Windows.MessageBox.Show($@"存在新版本 {args.CurrentVersion} 可用. 这是个必要的更新，点击确定开始更新程序...", @"软件更新",
                        MessageBoxButton.OK,
                        MessageBoxImage.Question);
            }
            else
            {
                dialogResult = System.Windows.MessageBox.Show($@"存在新版本 {args.CurrentVersion} 可用. 是否要下载更新?
更新内容：
