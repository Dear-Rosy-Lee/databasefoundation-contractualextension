...
using ToolSerialization = YuLinTu.Library.Business.ToolSerialization;
...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    public partial class ContractWarrantPrinter : AgricultureWordBook
    {
        ...
        protected YuLinTu.Library.Entity.ContractRegeditBook regBook = null;//承包权证

        protected ContractConcord otherConcord;
        protected YuLinTu.Library.Entity.ContractRegeditBook otherBook;
        ...
        /// 其他方式承包权证
        /// </summary>
        public YuLinTu.Library.Entity.ContractRegeditBook OtherBook
        {
            get
            {
                return otherBook;
        ...
        /// 承包权证
        /// </summary>
        public YuLinTu.Library.Entity.ContractRegeditBook RegeditBook
        {
            get
            {
                return regBook;
