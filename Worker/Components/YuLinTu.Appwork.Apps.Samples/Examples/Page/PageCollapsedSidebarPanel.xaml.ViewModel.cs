...
{
    [View(typeof(PageCollapsedSidebarPanel))]
    public partial class PageCollapsedSidebarPanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "PageCollapsedSidebarPanel Content";
        ...
        public PageCollapsedSidebarPanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
