...
namespace YuLinTu.Component.XiZangLZ
{
    ...
    /// 批量承包地块调查表任务类
    /// </summary>
    public class TaskGroupExportLandSurveyOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportLandSurveyOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportLandSurveyArgument groupArgument = Argument as TaskGroupExportLandSurveyArgument;
            ...
            List<YuLinTu.Library.Entity.VirtualPerson> selfAndSubsPersons = new List<YuLinTu.Library.Entity.VirtualPerson>();
            try
            {
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                argument.SelectedPersons = listPersons == null ? new List<YuLinTu.Library.Entity.VirtualPerson>() : listPersons;
                ...
                operation.Name = "批量导出承包地块Excel调查表";
