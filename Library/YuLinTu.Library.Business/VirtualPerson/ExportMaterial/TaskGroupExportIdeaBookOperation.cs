...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出无异议声明书任务类
    /// </summary>
    public class TaskGroupExportIdeaBookOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportIdeaBookOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportIdeaBookArgument groupArgument = Argument as TaskGroupExportIdeaBookArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportIdeaBookArgument argument = new TaskExportIdeaBookArgument();
                ...
                argument.Time = groupArgument.Time;
                argument.PubTime = groupArgument.PubTime;
                TaskExportIdeaBookOperation operation = new TaskExportIdeaBookOperation();
                operation.Argument = argument;
                operation.Name = "批量导出无异议声明书";
