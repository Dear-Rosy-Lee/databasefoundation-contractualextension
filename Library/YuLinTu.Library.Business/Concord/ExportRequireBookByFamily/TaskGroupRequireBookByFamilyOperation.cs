...
namespace YuLinTu.Library.Business
{
    ...
    /// 导出家庭承包单户申请书
    /// </summary>
    public class TaskGroupRequireBookByFamilyOperation : TaskGroup
    {
        ...
        {
            Clear();
            TaskGroupRequireBookByFamilyArgument groupMeta = Argument as TaskGroupRequireBookByFamilyArgument;
            if (groupMeta == null)
            {
                return;
            }
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                meta.ArgType = eContractConcordArgType.SingleExportRequireBook;
