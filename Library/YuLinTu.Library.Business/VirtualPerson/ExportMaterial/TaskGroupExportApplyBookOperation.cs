...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出户主声明书任务类
    /// </summary>
    public class TaskGroupExportApplyBookOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportApplyBookOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportApplyBookArgument groupArgument = Argument as TaskGroupExportApplyBookArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                TaskExportApplyBookArgument argument = new TaskExportApplyBookArgument();
                ...
                TaskExportApplyBookOperation operation = new TaskExportApplyBookOperation();
                operation.Argument = argument;
                operation.Name = "批量导出户主声明书";
