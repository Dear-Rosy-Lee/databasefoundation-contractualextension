...
namespace YuLinTu.Library.Business
{
    ...
    public class TaskContractDelayAccountOperation : Task
    {
        ...
        /// 构造函数
        /// </summary>
        public TaskContractDelayAccountOperation()
        {
        }
        ...
        public void ExportDataExcel(Zone zone, string fileName, double averagePercent = 0.0, double currentPercent = 0.0)
        {
            try
            {
                ...
                {
                    if (temp is ExportContractorDelaySurveyExcel)
                    {
                        export = (ExportContractorDelaySurveyExcel)temp;
                    }
        ...
        public void ExportSingleFamilyConfirmExcel(Zone zone, List<VirtualPerson> selectVirtualPerson, string fileName)
        {
            try
            {
                ...
                foreach (var item in selectVirtualPerson)
                {
                    ...
                    ++percentIndex;
                    using (ExportContractorDelaySurveyExcel export = new ExportContractorDelaySurveyExcel())
                    {
