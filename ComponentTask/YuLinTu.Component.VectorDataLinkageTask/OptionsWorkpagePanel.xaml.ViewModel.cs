...
{
    [View(typeof(OptionsWorkpagePanel))]
    public partial class OptionsWorkpagePanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties

        #region Properties - Common

        private string _Description = "OptionsWorkpagePanel Content";
        ...
        public OptionsWorkpagePanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
