...
namespace YuLinTu.Library.WorkStation
{
    ...
    /// 承包权证业务逻辑层接口定义
    /// </summary>
    public interface IContractRegeditBookWorkStation : IWorkstation<ContractRegeditBook>
    {
        #region Methods
        ...
        int AddRegeditBook(ContractRegeditBook book);
        ...
        int AddRange(List<ContractRegeditBook> listBook);
        ...
        /// <param name="searchOption">查找级别</param>
        /// <returns>权证</returns>
        ...
        /// 获取最新的权证流水号
        /// </summary>
        string GetNewSerialNumber(int minNumebr, int maxNumber);
