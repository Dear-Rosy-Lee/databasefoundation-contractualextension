...
{
    [View(typeof(OptionsWorkspacePanel))]
    public partial class OptionsWorkspacePanelViewModel : ViewModelObject, IDisposable
    {
        #region Properties
        ...
        {
            Workpage.Workspace.Message.Send(this, new MsgEventArgs<string>(EdCore.langShowOptionsDialog) { Parameter = "负责人" });
        }
        ...
        public OptionsWorkspacePanelViewModel(ITheWorkpage workpage) : base(workpage.Message)
        {
            Workpage = workpage;
        }
