...
namespace YuLinTu.Component.VectorDataDecoding.Core
{
    internal  class Constants
    {
        ...
        internal const string Methold_CreateVectorDecTask = Methold_Prefix + "task/add";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/task/add";
        internal const string Methold_QueryVectorDecTask = Methold_Prefix + "task/paging";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/task/paging";
        internal const string Methold_unclassified = Methold_Prefix + "data/download/unclassified";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/data/download/unclassified";
        internal const string Methold_decryption = Methold_Prefix + "data/download/decryption";//""/stackcloud/api/open/api/dynamic/onlineDecryption/data/download/decryption";
        internal const string Methold_upload = Methold_Prefix + "data/upload";//""/stackcloud/api/open/api/dynamic/onlineDecryption/data/upload";
        internal const string Methold_upload_decryption = Methold_Prefix + "data/upload/decryption";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/data/upload/decryption";
        internal const string Methold_StaticsLand = Methold_Prefix + "data/unclassified/statistics/dybm";//""/stackcloud/api/open/api/dynamic/onlineDecryption/data/unclassified/statistics/dybm";
        internal const string Methold_UpdateApprovalStatus = Methold_Prefix + "task/submit/approval";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/task/submit/approval";
        internal const string Methold_UpdateDownNum = Methold_Prefix + "task/update/pull/num";//""/stackcloud/api/open/api/dynamic/onlineDecryption/task/update/pull/num";

        internal const string Methold_Update_metadata = Methold_Prefix + "task/update/metadata_json";//""/stackcloud/api/open/api/dynamic/onlineDecryption/task/update/metadata_json";
        internal const string Methold_Delete_BatchTask = Methold_Prefix + "task/delete";//""/stackcloud/api/open/api/dynamic/onlineDecryption/task/delete";
        internal const string Methold_Delete_ClearBatchData = Methold_Prefix + "data/delete/by/upload_batch_num";//" "/stackcloud/api/open/api/dynamic/onlineDecryption/data/delete/by/upload_batch_num";
      //internal const string Methold_Delete_ClearBatchData = "/stackcloud/api/open/api/dynamic/onlineDecryption/task/submit/approval";
        internal const string Methold_UpLoadBatchDataNum = Methold_Prefix + "task/update/data/num";//""/stackcloud/api/open/api/dynamic/onlineDecryption/task/update/data/num";
        ...
        internal const string Methold_UpLoadProveFile = Methold_Prefix + "file/upload";//stackcloud/api/open/api/dynamic/onlineDecryption/file/upload";
        internal const string Methold_DownLoadProveFile = Methold_Prefix + "file/download"; //"/stackcloud/api/open/api/dynamic/onlineDecryption/file/download";
