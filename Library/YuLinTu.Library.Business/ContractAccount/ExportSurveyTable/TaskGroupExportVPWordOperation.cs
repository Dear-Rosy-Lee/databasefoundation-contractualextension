...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量导出承包方Word调查表任务类
    /// </summary>
    public class TaskGroupExportVPWordOperation : TaskGroup
    {
        #region Ctor
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupExportVPWordOperation()
        { }
        ...
        {
            Clear();
            TaskGroupExportVPWordArgument groupArgument = Argument as TaskGroupExportVPWordArgument;
            ...
            foreach (var zone in selfAndSubsZones)
            {
                ...
                argument.DictList = groupArgument.DictList;
