...
namespace YuLinTu.Library.Business
{
    ...
    /// 批量初始化界址点线任务参数
    /// </summary>
    public class TaskGroupInitializeLandDotCoilArgument : TaskInitializeLandDotCoilArgument
    {
        #region Fields
        ...
        ///// 界址线说明填写长度及方向
        ///// </summary>
        //public bool IsLineFindDescription { set; get; }

        ///// <summary>
        ///// 是否只进行界址线说明使用长度和方向填写说明
        ///// </summary>
        //public bool IsOnlyLineDescription { set; get; }
        ...
        /// 构造函数
        /// </summary>
        public TaskGroupInitializeLandDotCoilArgument()
        {
