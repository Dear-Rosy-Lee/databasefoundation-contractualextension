...
namespace YuLinTu.Component.NingMing
{
    ...
    /// 公示确认表设置实体
    /// </summary>
    public class PublicityConfirmDefineNingMing : NotifyCDObject
    {
        #region Propertys
        ...
        public PublicityConfirmDefineNingMing()
        {
            nameValue = true;
        ...
        /// </summary>
        /// <returns></returns>
        public static PublicityConfirmDefineNingMing GetIntence()
        {
            var systemCenter = TheApp.Current.GetSystemSettingsProfileCenter();  //系统配置
            var profile = systemCenter.GetProfile<PublicityConfirmDefineNingMing>();
            var section = profile.GetSection<PublicityConfirmDefineNingMing>();
