...
namespace YuLinTu.Library.Business
{
    ...
    /// </summary>
    [Serializable]
    public partial class ExportContractorDelaySurveyExcel : ExportExcelBase
    {
        #region Fields
        ...
        protected Library.Entity.ContractRegeditBook regeditBook;//承包权证
        ...
        protected PublicityConfirmDelayDefine contractLandOutputSurveyDefine = new PublicityConfirmDelayDefine();
        ...
        public ExportContractorDelaySurveyExcel()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual bool InitalizeValue()
        {
